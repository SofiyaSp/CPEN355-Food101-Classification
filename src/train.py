...
if __name__ == "__main__":
    ...
    train_model(baseline_model, train_loader, val_loader, optimizer_base, device, epochs=3)
    generate_outputs(baseline_model, val_loader, device, "baseline_cnn")
    ...
    train_model(eff_model, train_loader, val_loader, optimizer_eff, device, epochs=3)
    ...
    train_model(eff_model, train_loader, val_loader, optimizer_ft, device, epochs=2)
    generate_outputs(eff_model, val_loader, device, "efficientnet")